...
class Processor(threading.Thread):
    ...
    def do_REQUEST(self, value, round):
        ...
        logging.info('begining round %d with value %r and quorum %r' % (round, value, [p.name for p in quorum]))
        self.active_proposals[round] = dict(n = n, value = value, quorum = quorum, promises = {}, have_accepted = False)
    ...
    def do_PROPOSE(self, round, n, value, proposer):
        ...
        self.send(learners, 'ACCEPT', round = round, n = n, value = value)
